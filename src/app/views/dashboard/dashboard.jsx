...
import {Auth, KERI, Mail, Profile} from '../../services';
            ...
            <>
                <div style="position: relative">
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div class="flex flex-align-center">
                                                        <img src={task.imgSrc} alt={task.label}
                                                             style={{marginRight: '1rem', width: '72px'}}/>
                                                        <h3>{task.label}</h3>
                                                    </div>
                                                </Card>
                                            );
                                            ...
                                            {!this.aboutDismissed && !this.taskSelected && (
                                                <>
                                                    ...
                                                    <p class="font-color--battleship"
                                                       style={{lineHeight: '1.38', letterSpacing: '0.3px'}}>
                                                        This section is designed to help you navigate Keep and learn how
                                                        to complete tasks required
                                                        for your role. Click on one of the tasks on the left and this
                                                        panel will provide more
                                                        information.
                                                        <br/>
                                                        <br/>
                                                        If you are already familiar with the software, feel free to
                    ...
                    {/*<Select
                        ...
                        style="width:250px; position: fixed; bottom: 1rem; right: 1rem;"
                    /> */}
                    {/* <Select
            label="Port"
