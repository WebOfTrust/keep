...
class JoinCredentailIssuance {
  ...
  view(vnode) {
    return (
      <>
        {vnode.attrs.parent.currentState === 'approve-issue' && this.schema === Schema.LECredentialSchema && (
          <>
            ...
            <TextField outlined fluid style={{ margin: '0 5px 0 0' }} value={this.qvi} />
            <p class="p-tag-bold">Legal Entity vLEI Credential Recipient</p>
            <TextField outlined fluid style={{ margin: '0 10px 0 0' }} value={this.recipient.alias} />
            <p></p>
            <TextField outlined fluid style={{ margin: '0 0 0 0' }} value={this.recipient.id} />
            <p className="p-tag-bold">Enter the LEI:</p>
            <TextField outlined fluid style={{ margin: '0 0 0 0' }} oninput={(e) => {}} value={this.lei} />
        ...
        {vnode.attrs.parent.currentState === 'approve-issue' && this.schema === Schema.OORCredentialSchema && (
          <>
            ...
            <p className="p-tag">
              ...
              Organizational Role vLEI Credential, verify the recipient, the LEI number, Person Legal Name and Role for
              the recipient.
            </p>
            <p className="p-tag-bold">Your Qualified vLEI Issuer vLEI Credential</p>
            <TextField outlined fluid style={{ margin: '0 5px 0 0' }} value={this.qvi} />
            ...
            <TextField outlined fluid style={{ margin: '0 0 0 0' }} oninput={(e) => {}} value={this.personLegalName} />
            <p className="p-tag-bold">Official Role:</p>
            <TextField outlined fluid style={{ margin: '0 0 0 0' }} oninput={(e) => {}} value={this.officialRole} />
            <div class="flex flex-justify-between" style={{ marginTop: '4rem' }}>
              <Button
                raised
                class="button--gray-dk"
        ...
        {vnode.attrs.parent.currentState === 'approve-issue' && this.schema === Schema.ECRCredentialSchema && (
          <>
            <h3>Issue Legal Entity Engagement Context Role vLEI Credential</h3>
            <p className="p-tag">
              Ensure your Qualified vLEI Issuer vLEI Credential is selected to chain to the new Legal Entity Engagement
              Context Role vLEI Credential, verify the recipient, the LEI number, Person Legal Name and Role for the
              recipient.
            </p>
            <p className="p-tag-bold">Your Qualified vLEI Issuer vLEI Credential</p>
            <TextField outlined fluid style={{ margin: '0 5px 0 0' }} value={this.qvi} />
