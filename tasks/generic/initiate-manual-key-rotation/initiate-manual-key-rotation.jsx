...
class InitiateManualKeyRotation {
  ...
  rotateAID(vnode) {
    ...
    KERI.initiateGroupRotation(this.currentAID.name, rot)
      .then((rot) => {
      ...
      <>
            ...
            <div style={{marginTop: '3rem'}}>
              ...
              <Select
                ...
                onchange={(pool) => {
                  ...
                  if (this.currentAID.toad > this.wits.length
              ...
              />
              {this.wits.length > 0 &&
                <p className="p-tag-italic" style={{margin: '-0.5rem 0 0.25rem 1.5rem'}}>{this.wits.length} Witnesses in
                  Pool</p>}

              {this.canChangeToad && <div style={{marginTop: '1.5rem'}}>
                <div className="flex flex-justify-between" style={{margin: '0'}}>
                  <p class="p-tag">{this.mustChangeToad ? 'You must' : 'Would you like to'} change your witness
                    threshold:</p>
                  <TextField
                    outlined
                    type="number"
        ...
        {vnode.attrs.parent.currentState === 'review-and-confirm' && (
          <>
            ...
            <div class="uneditable-value"><AID aid={this.currentAID}/></div>
            ...
            {!MultiSig.fractionallyWeighted && <div><p class="font-weight--bold font-color--battleship">Number of Required Signers:</p>
