      ...
      <>
          ...
          <>
            ...
            <p className="p-tag" style={{ margin: '2rem 0' }}>
              {vnode.attrs.steps ? (
                ...
                <>
                  This module will take you through the steps of how to create and issue a signed data attestation of an
                  XBRL report:
                </>
              )}
            </p>
        ...
        {vnode.attrs.parent.currentState === 'select-attributes-file' && (
          <>
            ...
            />
            <div className="flex flex-justify-evenly" style={{ alignItems: 'center', margin: '4rem 0 4rem 0' }}>
              <>
                <input
                  type="file"
          ...
          <>
            ...
            <div className="flex flex-justify-center" style={{ margin: '1rem 0' }}>
              <Select
                ...
                onchange={(id) => {
                  this.credential = this.credentials.find((c) => {
                    return c['sad']['i'] === id;
                  });
              ...
              <div>
                <div>
                  <div style={{ margin: '0 0 2rem 0' }}>
                    ...
                    <TextField outlined fluid disabled style={{ margin: '0 0 0 0' }} value={this.reportTitle} />
                  </div>
                </div>
                <div style={{ margin: '0 0 2rem 0' }}>
                  <p className="p-tag-bold" style={{ margin: '1rem 0 0 0' }}>
        ...
        {vnode.attrs.parent.currentState === 'export-credential' && (
          <>
            ...
            <p className="p-tag" style={{ margin: '0 0 3rem 0' }}>
              Click on export to download a file containing your Verifiable iXBRL Report Attestation and all supporting
