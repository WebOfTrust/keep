      ...
      <>
        ...
        {this.currentState === 'steps-to-verify' && (
          <>
            <h3>Verify Credentials</h3>
            <p class="p-tag">
              This module will take you through the steps of how to authenticate Identity and verify credentials. Below
              are the steps for how to complete the process:
            </p>
        ...
        {this.currentState === 'initiate-video-call' && (
          <>
            ...
            <p class="p-tag">
              In order to start the authentication process, you will need to complete an real-time OOBI session in which
              you are both present, You will accept their text string on a Video Call so that you can receive their
