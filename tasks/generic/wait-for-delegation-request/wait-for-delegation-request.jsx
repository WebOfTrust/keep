  ...
  view(vnode) {
    return (
      <>
        ...
        >
          You just completed Identity Authentication with members of a new AID for which you will be the delegator. You
          will receive a notification from one of the members of the new AID with a request to approve their new AID
          with you as the delegator.
          <br />
          <br />
