      ...
      <>
        {vnode.attrs.parent.currentState === 'approve-delegation' && (
          <>
            ...
            <p class="p-tag">View the delegation request and confirm that these individuals are authenticated.</p>
          ...
          <>
            ...
            {this.ked.di && (
              <>
                ...
                <div className="flex flex-align-center flex-justify-between" style={{ margin: '0 0 4rem 0' }}>
        ...
        {vnode.attrs.parent.currentState === 'delegate-complete' && (
          <>
            ...
            <p class="p-tag">
              When enough members of {this.delegatorAlias} have approved the delegation you will receive a notification
              that the new delegated AID has been approved and created. You can also check the status of the anchoring
              event in the Multi-Sig Event Logs using the status button below.
            </p>
            <div class="flex flex-justify-between" style={{ marginTop: '4rem' }}>
              <Button
                raised
