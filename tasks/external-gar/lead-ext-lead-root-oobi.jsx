...
class LeadExtLeadRootOOBI {
  constructor(config) {
    ...
    this.sendOOBIPanel = {
      view: (vnode) => {
        return <LeadExtLeadRootOOBISend identifiers={Profile.identifiers} parent={this} end={vnode.attrs.end} />;
      },
    };

    this._component = {
      view: (vnode) => {
        return <LeadExtLeadRootOOBIRightPanel parent={this} end={vnode.attrs.end} />;
      },
    };
  }
    ...
    return (
      <>
        ...
        <p class="p-tag" style={{ margin: '2rem 0 2rem 0' }}>
          Join a call with the Lead Root GAR. Copy this OOBI URL for your default AID and paste it into the Video Call.
        </p>
...
class LeadExtLeadRootOOBIRightPanel {
  view(vnode) {
    return (
      <>
        <EnterChallengesForm
          identifiers={vnode.attrs.parent.rootIdentifier}
