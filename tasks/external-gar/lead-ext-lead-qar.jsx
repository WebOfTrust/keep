...
class LeadExtLeadQAROobi {
  constructor(config) {
    ...
    this.sendOOBIPanel = {
      view: (vnode) => {
        return <LeadExtLeadQAROOBISend parent={this} end={vnode.attrs.end} />;
      },
    };

    this._component = {
      view: (vnode) => {
        return <LeadExtLeadQAROOBIRightPanel parent={this} end={vnode.attrs.end} />;
      },
    };
  }
...
class LeadExtLeadQAROOBISend {
  view(vnode) {
    return (
      <>
        <h3>Accept OOBI from QARs</h3>
        <EnterOOBIsForm participants={vnode.attrs.parent.participants} />
      </>
    );
  }
}

class LeadExtLeadQAROOBIRightPanel {
  view(vnode) {
    return (
      <>
        {vnode.attrs.parent.currentState === 'one-way-oobi-challenge' && (
          <>
            ...
            <p class="p-tag" style={{ margin: '2rem 0 2rem 0' }}>
              Paste the message into the video chat so that your contact can be verified
              <br />
              <br />
              <strong>
        ...
        {vnode.attrs.parent.currentState === 'event-complete' && (
          <>
            ...
            <p class="p-tag">
              Thank you for authenticating all members. You will receive a notification when the QARs have created their
              Multi-Sig AID and are requesting delegation.
            </p>
...
module.exports = LeadExtLeadQAROobi;
