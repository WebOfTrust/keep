...
const RootGarVariables = {
  ...
  createGLEIFRoot: {
    shouldSkipTitle: 'Do you need to perform identity authentication with members of the GLEIF RoOT AID?',
    shouldSkipIntro:
  ...
  approveDelegation: {
    shouldSkipTitle: 'Do you need to perform identity authentication with members of the Delegated AID?',
    shouldSkipIntro:
