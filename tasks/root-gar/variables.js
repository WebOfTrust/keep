...
const RootGarVariables = {
  ...
  createGLEIFRoot: {
    ...
    shouldSkipIntro: "If you have not yet exchanged OOBIs with the other participants of the GLEIF RoOT AID, you must perform identity authentication to add them to your contact list." +
    ...
    performIntro: "Proceed to exchange OOBIs with the other participants of the GLEIF Root AID. You will also be sending them a challenge message that they will send back to you.",
    ...
    nextTaskBody: "If you have been designated to configure the multi-sig group click Yes to continue to provide the group alias and select the participants. Otherwise click no and enjoy the wait."
  },
  approveDelegation: {
    shouldSkipTitle: "Do you need to perform identifiy authentication with members of the Delegated AID?",
    shouldSkipIntro: "If you have not yet exchanged OOBIs with participants of the new Delegated AID, you must perform identity authentication to add them to your contact list." +
      "  Will you be need to perform identity authentication?",
    ...
    performTitle: "Proceed to OOBI Exchange",
    performIntro: "Proceed to exchange OOBIs with the participants of the new delegated AID. You will also be sending them a challenge message that they will send back to you.",
  ...
  manualKeyRotation: {
    ...
    shouldSkipIntro: "New participants are participants that you have not yet exchanged OOBIs with you and are not in your contact list. Will you be adding new people to this rotation?",
    skipTitle: "Proceed to Multi-Sig Group Rotation",
    skipIntro: "You can now proceed to configuring your Multi-Sig Group Rotation with only existing participants from the group.",
    performTitle: "Proceed to OOBI Exchange",
    performIntro: "Proceed to exchange OOBIs with the new participants you would like to add. You will also be sending them a challenge message that they will send back to you.",
    title: "Manual Key Rotation",
    subtitle: "Steps for rotation:",
    intro: "If you are adding new members to this Multi-Sig Group AID, you need to perform the following steps.  Otherwise, you can Skip this step and begin configuring the rotation.",
    steps: (
      <ol className="styled-ol margin-v-2">
    ...
    joinCallIntro: "In order to begin a rotation, you will need to initiate an real-time Out of Band Interaction (OOBI) session with new members of the Multi-Sig Group in which you and the other users are present, You will accept all their OOBIs (URL + AID) on a Video Call so that you can approve the complete the rotation.",
    joinCallSubIntro: "",
