...
const RootGarVariables = {
    createYourAid: {
        welcome: {
            title: (
                <>
                    Welcome to your Root <TextTooltip label={<u>Root GAR</u>}>GLEIF Authorized
                    Representative</TextTooltip>{' '}
                    Software
                </>
            ),
            paragraph: (
        ...
        creatingAID: {
            title: (
                <>
                    Creating Your <TextTooltip label={<u>AID</u>}>AID is your identifier for your Root Gar
                    software.</TextTooltip>
                </>
            ),
            paragraph: (
                <>
        ...
        steps: [
            {
                ...
                paragraph: (
                    <>
                        ...
                        serving in the
                        role of QAR. A GAR and the QAR will complete a real-time OOBI session in which the GAR and the
                        QAR are
                        present.
                    </>
                ),
